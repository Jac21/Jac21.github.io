...
\vspace{0.2in}
   ...
   \item Responsible for the delivery of key financial technology applications and services supporting the Schwab Portfolio Performance Reporting initiative impacting millions of clients, utilizing .NET Core C\#, WebAPI, and the NoSQL database Aerospike, in an Agile and Cloud based environment. 
\newline
