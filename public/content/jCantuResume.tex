...
\vspace{0.2in}
   ...
   \item Led globally distributed teams in the architecture, development, and performance tuning of critical financial technology applications and batch services supporting the Schwab Portfolio Performance Reporting platform impacting nearly 50 million clients, utilizing .NET C\#, WebAPI, and the NoSQL database Aerospike in an Agile and private cloud-based environment. 
 \end{itemize}
